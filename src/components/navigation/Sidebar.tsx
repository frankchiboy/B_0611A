        ...
        {expanded && currentProject && (
          <div className="mb-6">
            <div className="relative">
              ...
              {/* 專案列表下拉選單 */}
              {showProjectList && (
                <div className="absolute top-full left-0 right-0 bg-white rounded-lg shadow-lg border border-slate-200 py-2 z-50 max-h-64 overflow-y-auto">
                  <div className="px-3 py-2 border-b border-slate-100">
                    <h4 className="text-xs font-medium text-slate-500 uppercase">選擇專案</h4>
                  </div>
                  ...
                  {projects.map(project => (
                    <button
                      ...
                      className={`w-full px-3 py-2 text-left hover:bg-slate-50 transition-colors ${
                        currentProject.id === project.id ? 'bg-teal-50 text-teal-700' : 'text-slate-700'
                      }`}
                    >
                      <div className="flex items-center">
                        <div className="flex-1 min-w-0">
                  ...
                  <div className="border-t border-slate-100 mt-2 pt-2">
                    <button
                      onClick={handleCreateNewProject}
                      className="w-full px-3 py-2 text-left text-sm text-teal-600 hover:bg-teal-50 transition-colors flex items-center"
                    >
