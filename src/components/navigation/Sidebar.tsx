        ...
        {expanded && currentProject && (
          <div className="mb-6">
            <div className="relative">
              ...
              {/* 專案列表下拉選單 - 修復可見性 */}
              {showProjectList && (
                <div className="absolute top-full left-0 right-0 z-[9999] max-h-64 overflow-y-auto">
                  <div className="bg-white rounded-lg shadow-2xl border border-slate-300 overflow-hidden">
                    ...
                    <div className="bg-white">
                      ...
                      <div className="border-t border-slate-200 bg-slate-50">
                        <button
                          onClick={handleCreateNewProject}
                          className="w-full px-3 py-2 text-left text-sm text-teal-700 hover:bg-teal-50 transition-colors flex items-center font-medium bg-slate-50"
                        >
